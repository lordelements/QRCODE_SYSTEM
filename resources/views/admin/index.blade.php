...
<section class="no-padding-top no-padding-bottom">
    <div class="container-fluid">
        ...
        <div class="col-lg-12">
            <div class="block">
                <div class="title"><strong>List of Generated QR Code</strong></div>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset('storage/' . $qr->qr_code_path) }}" alt="QR Code" class="img-fluid" style="height: 50px;">
                                </td>
                                <td>

                                    <a href="{{ route('admin.download_qr_codeURL', $qr->id) }}" class="btn btn-outline-secondary btn-sm">
